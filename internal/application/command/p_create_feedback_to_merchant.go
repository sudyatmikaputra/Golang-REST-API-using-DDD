...
func (r CreateFeedbackCommand) ExecuteToMerchant(ctx context.Context, params public.CreateFeedbackRequest) (*public.FeedbackResponse, error) {

	feedback, err := r.feedbackService.CreateFeedback(ctx, &public.CreateFeedbackRequest{
		FeedbackTo:      string(internal.ToMerchant),
