...
type FeedbackParameterServiceInterface interface {
	...
	GetFeedbackParameter(ctx context.Context, parameterID uuid.UUID) (*public.FeedbackParameterResponse, error)
	GetFeedbackParameterByParameterType(ctx context.Context, parameterType internal.ParameterType, languageCode string) (*public.FeedbackParameterResponse, error)
